...
def add_data_layer(net):
    ...
    #net.data = L.Input(name="data", input_param={'shape': {'dim': [1, 3, 320, 320]}})
    #net.input_dim.extend([1, 3, 108, 192])


def copy_and_modify(ori_net, net, net_map, to_delete_layernames):
    print net_map
    print to_delete_layernames
    add_data_layer(net)
...
def pick_empty_layers(layer, net):
    ...
    if layer.type == 'Scale' and layer.name in net.params.keys():
